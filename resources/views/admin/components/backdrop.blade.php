...
<div
      ...
      ></div>
      <aside
        class="fixed inset-y-0 z-20 w-64 mt-16 overflow-y-auto bg-white shrink-0 md:hidden"
        x-show="isSideMenuOpen"
        x-transition:enter="transition ease-in-out duration-150"
      ...
      >
        <div class="py-4 text-gray-500 ">
          ...
          <ul class="mt-6">
            <p class="text-sm font-thin text-center text-gray-500 uppercase">Dashboard</p>
          ...
          <ul>
            ...
            >
                ...
                <ul
                    ...
                    class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md bg-gray-50"
                    aria-label="submenu"
                >
                    <li class="px-2 py-1 hover:text-gray-800">
                        <a class="block w-full" href="{{ route('admin.terhubung.index') }}">
                            Mari Terhubung
                        </a>
                    </li>

                    <li class="px-2 py-1 hover:text-gray-800">
                        <a class="block w-full" href="{{ route('admin.doa.index') }}">
                            Intensi / Ujud Doa
                        </a>
                    </li>
                </ul>
