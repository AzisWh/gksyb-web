<section class="w-full py-16 fs-style-manrope bg-white text-[#3D0E0E]" data-aos="fade-up">
    <div class="container mx-auto px-4">
        ...
        <div class="mt-4 grid md:grid-cols-2 gap-6 font-light">
            <h2 class="text-3xl md:text-6xl font-semibold leading-tight">
                Agenda Kegiatan Gereja<br>
                Santo Yusup Bintaran
            </h2>

            <p class="text-base opacity-80 text-sm md:text-lg ">
                Ikuti berbagai kegiatan rohani dan komunitas yang mempererat persaudaraan iman di Gereja Santo Yusup Bintaran.
            </p>
        </div>
