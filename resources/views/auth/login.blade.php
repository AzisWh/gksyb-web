...
<body >
    ...
    <main >
        <div class="min-h-screen bg-[#F5F5ED] flex items-center justify-center p-4 fs-style-manrope ">
            <div class="w-full max-w-md p-8 bg-white shadow-xl rounded-xl">
                <div class="flex flex-col items-center justify-center ">
                    ...
                    <h2 class="text-2xl font-bold text-center text-gray-900">Admin Panel</h2>
                ...
                <form class="space-y-4" method="POST" action="{{ route('login.authenticate') }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            >
                                <svg id="eyeOpen" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <svg id="eyeClose" xmlns="http://www.w3.org/2000/svg" class="hidden w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 012.563-4.112M6.88 6.88A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411M15 12a3 3 0 00-3-3m0 0a3 3 0 00-3 3m3-3L3 3" />
                                </svg>
                            </span>
                        </div>
                    </div>
