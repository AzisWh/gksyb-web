...
class AdminTerhubungController extends Controller
{
    ...
    public function updateStatus(Request $request, $id)
    {
        try{
            ...
            $terhubung->save();
            Alert::success('Berhasil', 'Status pesan berhasil diperbarui.');
            return redirect()->route('admin.terhubung.index');
        }catch(\Exception $e){
            Alert::error('Gagal', 'Terjadi kesalahan saat memperbarui status: ' . $e->getMessage());
            return redirect()->route('admin.terhubung.index');
        }
